                  ...
                  children: [
                            ...
                            child: Row(
                              ...
                              children: [
                                InkWell(
                                  onTap: () async {
                                    logFirebaseEvent(
                                        'EDIT_PROFILE_PAGE_Icon_y2n9pm73_ON_TAP');
                                    logFirebaseEvent('Icon_Upload-Photo-Video');
                                    final selectedMedia =
                      ...
                      child: Row(
                        ...
                        children: [
                          InkWell(
                            onTap: () async {
                              logFirebaseEvent(
                                  'EDIT_PROFILE_PAGE_Text_95vpgcf5_ON_TAP');
                              logFirebaseEvent('Text_Alert-Dialog');
                              await showDialog(
                                context: context,
                                builder: (alertDialogContext) {
                                  return AlertDialog(
                                    title: Text('How we use this information:'),
                                    content: Text(
                          ...
                          onPressed: () async {
                            ...
                            if ((textController2?.text ?? '') == '10') {
                              ...
                              final usersUpdateData = createUsersRecordData(
                                ...
                                grade: int.parse(textController2?.text ?? ''),
                              ...
                              if ((textController2?.text ?? '') == '11') {
                                ...
                                if ((textController2?.text ?? '') == '12') {
                                  ...
                                  await showDialog(
                                    ...
                                    builder: (alertDialogContext) {
                                      return AlertDialog(
                                        title: Text('Correct Grade Required!'),
                                        content: Text(
                    ...
                    Padding(
                      ...
                      child: InkWell(
                        onTap: () async {
                          logFirebaseEvent(
                              'EDIT_PROFILE_PAGE_Text_22l7b3iw_ON_TAP');
